...
/// is unaffected.
pub fn allocate(cfg: &PanelConfig, inner_width: usize) -> Vec<Allocated> {
    allocate_full(cfg, inner_width).columns().to_vec()
}
