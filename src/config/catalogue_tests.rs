...
/// `api.github.com/repos/xls/holos/contents/themes?ref=main`, trimmed of the
...
const REAL: &str = r#"[{"name":"ayu-dark.toml","path":"themes/ayu-dark.toml","sha":"a39aab68","size":2375,"url":"https://api.github.com/repos/xls/holos/contents/themes/ayu-dark.toml?ref=main","download_url":"https://raw.githubusercontent.com/xls/holos/main/themes/ayu-dark.toml","type":"file","_links":{"self":"https://api.github.com/repos/xls/holos/contents/themes/ayu-dark.toml?ref=main","git":"https://api.github.com/repos/xls/holos/git/blobs/a39aab68","html":"https://github.com/xls/holos/blob/main/themes/ayu-dark.toml"}},{"name":"tokyo-night.toml","path":"themes/tokyo-night.toml","sha":"b1","size":2400,"type":"file","_links":{"self":"x"}}]"#;
...
fn the_urls_name_the_project_repository() {
    assert_eq!(
        contents_url(),
        "https://api.github.com/repos/xls/holos/contents/themes?ref=main"
    );
    assert_eq!(
        theme_url("dracula"),
        "https://raw.githubusercontent.com/xls/holos/main/themes/dracula.toml"
    );
}
