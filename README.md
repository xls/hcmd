...
- **SFTP and FTP.** Connect a panel to a host and it behaves like any other
  panel: copy, view, search, and browse an archive that lives on the far end.
...
**SFTP and FTP (`Ctrl+F`).** A quick-connect line or a saved host. Once
...
| `hosts.toml` | saved SFTP and FTP connections |
